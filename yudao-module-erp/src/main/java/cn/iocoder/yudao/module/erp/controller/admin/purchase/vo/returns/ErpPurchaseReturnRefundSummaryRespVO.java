...
@Schema(description = "管理后台 - ERP 采购退货退款核销摘要 Response VO")
@Data
@Accessors(chain = true)
public class ErpPurchaseReturnRefundSummaryRespVO {
    ...
    @Schema(description = "已退/已核销金额", requiredMode = Schema.RequiredMode.REQUIRED, example = "60.00")
