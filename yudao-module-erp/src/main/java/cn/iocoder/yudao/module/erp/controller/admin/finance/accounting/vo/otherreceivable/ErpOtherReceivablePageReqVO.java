...
@Schema(description = "管理后台 - ERP 其他应收单分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ErpOtherReceivablePageReqVO extends PageParam {

    @Schema(description = "单号", example = "QTYS20260516000001")
    private String no;
