...
@Schema(description = "管理后台 - ERP 收款单明细分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ErpFinanceReceiptItemPageReqVO extends PageParam {
    ...
    @Schema(description = "排序字段，支持：id, bizType, bizId, bizNo, totalPrice, receiptedPrice, receiptPrice, writeOffStatus, remark")
