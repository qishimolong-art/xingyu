...
@Schema(description = "管理后台 - ERP 销售调价导入解析 Response VO")
@Data
public class ErpSalePriceAdjustImportRespVO {
    ...
    private List<ErpSalePriceAdjustSaveReqVO.Item> items = new ArrayList<>();
