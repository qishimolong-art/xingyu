...
public class ErpSaleReturnSaveReqVO {
    ...
    @Schema(description = "退货模式：0 旧销售订单；10 按销售单；20 按库存", example = "10")
    ...
    @Schema(description = "来源销售单编号", example = "17386")
    private Long sourceOutId;

    @Schema(description = "来源销售单号", example = "XSCK20260510000001")
    ...
    public static class Item {
        ...
        @Schema(description = "来源销售单项编号", example = "11756")
