...
@Schema(description = "管理后台 - ERP 预收款单新增/修改 Request VO")
@Data
public class ErpPreReceiptSaveReqVO {
    ...
    @Schema(description = "往来方名称", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "往来方名称不能为空")
