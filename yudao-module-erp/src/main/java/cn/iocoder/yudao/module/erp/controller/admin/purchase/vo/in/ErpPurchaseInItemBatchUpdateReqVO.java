...
@Schema(description = "管理后台 - ERP 采购入库明细批量修改 Request VO")
@Data
public class ErpPurchaseInItemBatchUpdateReqVO {

    @Schema(description = "采购入库编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "17386")
    @NotNull(message = "采购入库编号不能为空")
    private Long inId;

    @Schema(description = "采购入库明细编号列表", requiredMode = Schema.RequiredMode.REQUIRED)
