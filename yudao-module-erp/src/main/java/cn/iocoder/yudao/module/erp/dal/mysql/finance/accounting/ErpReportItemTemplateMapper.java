...
public interface ErpReportItemTemplateMapper extends BaseMapperX<ErpReportItemTemplateDO> {
    ...
    default PageResult<ErpReportItemTemplateDO> selectPage(ErpReportItemTemplatePageReqVO reqVO) {
        LambdaQueryWrapperX<ErpReportItemTemplateDO> wrapper = new LambdaQueryWrapperX<ErpReportItemTemplateDO>()
        ...
        ErpKeywordQuery.append(wrapper, reqVO.getKeyword(),
                ErpReportItemTemplateDO::getItemName, ErpReportItemTemplateDO::getFormula,
                ErpReportItemTemplateDO::getRemark);
        wrapper.orderByAsc(ErpReportItemTemplateDO::getSort)
                .orderByAsc(ErpReportItemTemplateDO::getRowNo);
