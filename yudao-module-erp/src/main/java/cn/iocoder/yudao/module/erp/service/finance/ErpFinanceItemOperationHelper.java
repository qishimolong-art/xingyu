 ...
 * 资金单据子表增量操作工具。
 */
public final class ErpFinanceItemOperationHelper {

    public static final String OPERATION_INSERT = "insert";
    public static final String OPERATION_UPDATE = "update";
    public static final String OPERATION_DELETE = "delete";

    private ErpFinanceItemOperationHelper() {
    }

    public static <T> boolean useIncrementalItems(List<T> items, Function<T, String> operationGetter,
    ...
    public static <REQ, OLD> RequestChangeSet<REQ> buildRequestChangeSet(
            List<REQ> items,
            List<OLD> oldItems,
        ...
        if (CollUtil.isEmpty(items)) {
            return new RequestChangeSet<>(finalItems, updateIds, deleteIds);
        }
    ...
    public static final class RequestChangeSet<REQ> {

        private final List<REQ> finalItems;
        private final Set<Long> updateIds;
        private final Set<Long> deleteIds;

        private RequestChangeSet(List<REQ> finalItems, Set<Long> updateIds, Set<Long> deleteIds) {
            this.finalItems = finalItems;
            this.updateIds = updateIds;
            this.deleteIds = deleteIds;
        }

        public List<REQ> getFinalItems() {
            return finalItems;
        }
