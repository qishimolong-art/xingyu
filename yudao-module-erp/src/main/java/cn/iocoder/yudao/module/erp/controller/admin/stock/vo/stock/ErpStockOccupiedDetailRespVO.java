...
@Schema(description = "Admin - ERP stock occupied detail Response VO")
@Data
public class ErpStockOccupiedDetailRespVO {

    @Schema(description = "Document type", example = "SALE_OUT")
    private String documentType;

    @Schema(description = "Document id", example = "1")
    private Long documentId;

    @Schema(description = "Sale cart id", example = "1")
    private Long cartId;

    @Schema(description = "Sale cart item id", example = "10")
    private Long itemId;

    @Schema(description = "No", example = "XSTC202607130001")
    private String no;
