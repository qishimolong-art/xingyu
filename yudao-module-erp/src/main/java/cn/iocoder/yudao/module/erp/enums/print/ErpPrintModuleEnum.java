...
public enum ErpPrintModuleEnum {
    ...
    PAYABLE_MISC("payable_misc", "其他应付", "erp_finance_payable_misc", "erp:payable-misc"),
    PAYABLE_OTHER("payable_other", "应付调账", "erp_finance_payable_other", "erp:payable-other"),
    PAYABLE_EXPENSE("payable_expense", "费用支付", "erp_finance_payable_expense", "erp:payable-expense"),
    RECEIVABLE_MISC("receivable_misc", "其他应收", "erp_finance_receivable_misc", "erp:receivable-misc"),
    RECEIVABLE_OTHER("receivable_other", "应收调账", "erp_finance_receivable_other", "erp:receivable-other"),
