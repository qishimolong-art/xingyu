...
public interface ErpPayableAccountMapper extends BaseMapperX<ErpPayableAccountDO> {
    ...
    @Select({
            ...
            "       IFNULL(pi.purchaseInAmount, 0) + IFNULL(pa.priceAdjustAmount, 0) - IFNULL(pr.purchaseReturnAmount, 0) - IFNULL(fp.paymentAmount, 0) AS balance,",
            ...
            "   AND (IFNULL(pi.purchaseInAmount, 0) + IFNULL(pa.priceAdjustAmount, 0) - IFNULL(pr.purchaseReturnAmount, 0) - IFNULL(fp.paymentAmount, 0)) &lt;&gt; 0",
            "   </if>",
