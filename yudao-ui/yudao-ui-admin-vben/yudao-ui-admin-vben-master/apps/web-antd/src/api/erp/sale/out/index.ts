...
export function getReturnableItemsByOutId(outId: number) {
  return requestClient.get<ErpSaleOutApi.SaleReturnableItem[]>(
    `/erp/sale-out/returnable-items?outId=${outId}`,
  );
}
