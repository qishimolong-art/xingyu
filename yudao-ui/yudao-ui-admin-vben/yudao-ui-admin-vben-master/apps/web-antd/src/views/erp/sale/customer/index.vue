...
async function handleFormSuccess(id?: number) {
  handleRefresh();
  if (id) {
    detailModalApi.setData({ id } as ErpCustomerApi.Customer).open();
  }
}
...
/** 查看客户详情 */
function handleDetail(row: ErpCustomerApi.Customer) {
