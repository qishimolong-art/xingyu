...
export function useFormSchema(formType: string): VbenFormSchema[] {
  return [
    ...
    {
      fieldName: 'returnMode',
      label: '退货模式',
      component: 'RadioGroup',
      defaultValue: 10,
      componentProps: {
        disabled: formType === 'edit' || formType === 'detail',
        buttonStyle: 'solid',
        optionType: 'button',
        options: [
          { label: '按入库单退货', value: 10 },
          { label: '按库存退货', value: 20 },
        ],
      },
      rules: 'required',
    ...
    {
      fieldName: 'sourceInNo',
      label: '原入库单',
      component: 'Input',
      formItemClass: 'col-span-1',
      dependencies: {
        triggerFields: ['returnMode'],
        show: (values: any) => values.returnMode === 10,
      },
      componentProps: {
        disabled: true,
...
export function useFormItemColumns(
  ...
  return [
    ...
    },
    {
      ...
      title: '适用车型',
      minWidth: 120,
      slots: { default: 'vehicleModel' },
    },
    {
      field: 'originPlace',
      title: '产地',
      minWidth: 100,
      slots: { default: 'originPlace' },
    },
    {
      field: 'stockCount',
      title: '库存',
...
export function useGridColumns(): VxeTableGridOptions['columns'] {
  return [
    ...
    },
    {
      ...
      width: 110,
      formatter: ({ cellValue }) => {
        if (cellValue === 10) return '按入库单退货';
        if (cellValue === 20) return '按库存退货';
        return '-';
      },
    },
    {
