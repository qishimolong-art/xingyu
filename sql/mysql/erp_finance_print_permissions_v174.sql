-- ERP finance module print permissions (v174).
...
DROP TEMPORARY TABLE IF EXISTS tmp_erp_finance_print_permission;

CREATE TEMPORARY TABLE tmp_erp_finance_print_permission (
...
INSERT INTO tmp_erp_finance_print_permission
(`parent_permission`, `inherit_permission`, `button_name`, `button_permission`, `sort`)
VALUES
('erp:finance-payment:query', 'erp:finance-payment:query', '付款单打印', 'erp:finance-payment:print', 7),
('erp:finance-payment:query', 'super_admin', '付款单打印模板', 'erp:finance-payment:print-template', 8),
('erp:finance-receipt:query', 'erp:finance-receipt:query', '收款单打印', 'erp:finance-receipt:print', 7),
('erp:finance-receipt:query', 'super_admin', '收款单打印模板', 'erp:finance-receipt:print-template', 8),
('erp:finance-transfer:query', 'erp:finance-transfer:query', '银行转账打印', 'erp:finance-transfer:print', 7),
('erp:finance-transfer:query', 'super_admin', '银行转账打印模板', 'erp:finance-transfer:print-template', 8);
...
SELECT perm.button_name,
       ...
       NOW(),
       b'0'
FROM tmp_erp_finance_print_permission perm
