-- ERP purchase module print permissions (v171).
...
DROP TEMPORARY TABLE IF EXISTS tmp_erp_purchase_print_permission;

CREATE TEMPORARY TABLE tmp_erp_purchase_print_permission (
...
INSERT INTO tmp_erp_purchase_print_permission
(`parent_permission`, `inherit_permission`, `button_name`, `button_permission`, `sort`)
VALUES
('erp:purchase-in:query', 'erp:purchase-in:query', '采购入库打印', 'erp:purchase-in:print', 7),
('erp:purchase-in:query', 'super_admin', '采购入库打印模板', 'erp:purchase-in:print-template', 8),
('erp:purchase-return:query', 'erp:purchase-return:query', '采购退货打印', 'erp:purchase-return:print', 7),
('erp:purchase-return:query', 'super_admin', '采购退货打印模板', 'erp:purchase-return:print-template', 8),
('erp:purchase-invoice:query', 'erp:purchase-invoice:query', '采购发票打印', 'erp:purchase-invoice:print', 7),
('erp:purchase-invoice:query', 'super_admin', '采购发票打印模板', 'erp:purchase-invoice:print-template', 8),
('erp:purchase-price-adjust:query', 'erp:purchase-price-adjust:query', '采购调价打印', 'erp:purchase-price-adjust:print', 7),
('erp:purchase-price-adjust:query', 'super_admin', '采购调价打印模板', 'erp:purchase-price-adjust:print-template', 8);
...
SELECT perm.button_name,
       ...
       NOW(),
       b'0'
FROM tmp_erp_purchase_print_permission perm
