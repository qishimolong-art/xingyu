...
CREATE TABLE IF NOT EXISTS `product_spu` (
    ...
    `code` varchar(64) DEFAULT NULL COMMENT '配件编码',
    `standard` varchar(128) DEFAULT NULL COMMENT '配件规格',
    `feature_code` varchar(64) DEFAULT NULL COMMENT '配件特征码',
    `vehicle_model` varchar(128) DEFAULT NULL COMMENT '适用车型',
